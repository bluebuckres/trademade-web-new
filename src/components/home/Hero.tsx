            ...
            <AsymmetricContainer ratio="50/50">
                <div className="flex flex-col justify-center max-w-2xl">
                    ...
                    <div className="flex flex-wrap items-center gap-4">
                        <MagneticButton href="https://trademade.neetocal.com/6f2bfcb1-b1de-4959-a78e-993d3194d7a1" target="_blank" className="bg-primary hover:bg-primary-hover text-[#000000] shadow-[0_0_20px_rgba(0,212,170,0.3)] border-none cursor-pointer">
                            ▶ Book a Quick Call
                        </MagneticButton>
