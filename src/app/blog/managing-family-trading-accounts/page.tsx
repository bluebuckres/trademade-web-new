      ...
      <article className="max-w-[680px] mx-auto px-6 pt-8 md:pt-0">
        ...
        <header className="mb-10 border-b-2 border-[#0c0c0c] pb-8">
          ...
          <p className="text-[18px] font-light text-[#3a3a3a] leading-[1.6] mb-5 font-playfair italic">
            The real operational challenges of running a friends-and-family fund
            in India — and a setup that actually scales without daily headaches.
          </p>
        ...
        <div className="text-[17px] leading-[1.8] font-light text-[#0c0c0c]">
          <p className="mb-6">
            Managing your own trading account is one job. Managing money for 23
            family members is a completely different job that happens to use
            some of the same vocabulary.
          </p>

          <p className="mb-6">
            This is how <strong>Arvind</strong> — a former software engineer
            turned quant trader from Mumbai — went from spending his mornings
            frantically copy-pasting orders across browser tabs to running a
            clean, automated multi-account operation before market open.
          </p>
          ...
          <p className="mb-6">
            Arvind spent four years building and refining his system before he
            touched a single rupee of family capital. Eighteen months of live
            results on his own account first. He knew what he was doing.
          </p>

          <p className="mb-6">
            What he didn't account for was what actually managing money for real
            people — people who call you when markets are red, people who
            forward you WhatsApp articles about "algo trading scams," people who
            trusted you with their savings — actually requires operationally.
          </p>
          ...
          <p className="mb-6">
            Before automating, Arvind's morning looked like this: Market opens
            at 9:15am. Strategy signals fire. He places the trade in his own
            account first. Then — account by account — he replicates it. Copy
            order details. Switch browser tab. Log in. Place order. Confirm.
            Repeat across 23 accounts.
          </p>
          ...
          <div className="border border-[#dad5cc] bg-white p-6 my-8">
            ...
            <ul className="list-disc pl-5 space-y-2 text-[15px]">
              ...
              <li>
                By the time he finished, <strong>4–6 minutes had passed</strong>{" "}
                from his first execution
              </li>
            </ul>
          </div>

          <p className="mb-6">
            In intraday momentum trading, 4–6 minutes is enormous. Some accounts
            got good fills. Others were chasing a price that had moved. Every
            account had a slightly different P&L for the same strategy — which
            creates exactly the kind of trust-destroying questions you don't
            want to answer.
          </p>
          ...
          <div className="flex flex-col gap-6 my-8">
            <div className="bg-[#edeae2] p-6 border-l-2 border-[#0c0c0c]">
              ...
              <p className="text-[15px] leading-[1.6] m-0">
                ...
                three accounts had skipped four trades, for no visible reason.
              </p>
            </div>
            ...
            <div className="bg-[#edeae2] p-6 border-l-2 border-[#0c0c0c]">
              ...
              <p className="text-[15px] leading-[1.6] m-0">
                He had that conversation once. Eight family members would have
                needed to switch brokers, transfer holdings, and go through KYC
                again. He quietly dropped the idea.
              </p>
            </div>
          </div>
          ...
          <div className="py-6 my-10 border-y border-[#dad5cc]">
            <p className="font-playfair text-[20px] font-semibold italic leading-[1.5] text-[#3a3a3a] m-0">
              "The strategy had a real edge. But I was delivering a different
              P&L to every account for reasons that had nothing to do with the
              strategy. That's not a business. That's chaos with good
              intentions."
            </p>
          </div>
          ...
          <p className="mb-6">
            The framing that changed things for Arvind: think of it not as "copy
            trading" but as{" "}
          ...
          <p className="mb-6">
            ...
            rules, exit conditions — defined once. When a signal fires, every
            account executes within the same second. He places one order. The
            infrastructure handles the rest across every broker simultaneously.
          </p>
          ...
          <ul className="space-y-6 my-8">
            ...
            <li className="flex gap-4 items-start">
              ...
              <div>
                ...
                His family members have very different capital bases. TradeMade
                lets him set sizing rules per account — so the same signal
                doesn't put the same absolute rupee amount into a conservative
                small account as a large one. He'd been doing that math
                manually. Getting it wrong occasionally. Now it's automatic.
              </div>
            </li>
            <li className="flex gap-4 items-start">
              <div className="w-1.5 h-1.5 rounded-full bg-[#0c0c0c] mt-2.5 shrink-0" />
              <div>
                ...
                Direct. All of them execute from the same strategy deployment.
                No one needs to switch brokers.
              </div>
            </li>
          </ul>
          ...
          <p className="mb-6">
            The 7pm calls from family still happen. But they're about strategy
            questions now — genuine curiosity about how the system works — not
            "what happened, why did my account miss that trade."
          </p>

          <p className="mb-6 font-bold text-[#0c0c0c]">
            That is a conversation Arvind can have. The other one was quietly
            destroying trust.
          </p>
          ...
          <p className="mb-6">
            Honestly, the operational checklist before you scale this kind of
            setup:
          </p>

          <ol className="list-decimal pl-5 space-y-4 mb-8 text-[16px]">
            <li>
              <strong>Don't start manually</strong> — it feels manageable at 3
              accounts and becomes unmanageable at 8.
            </li>
            <li>
              <strong>Assume different brokers</strong> — standardizing accounts
              is a harder conversation than you think.
            </li>
            <li>
          ...
          <div className="mt-14 pt-8 border-t-2 border-[#0c0c0c] text-[14px]">
            <p className="mb-4 text-[#3a3a3a] italic">
              ...
              per-account position sizing and real-time execution sync. Used by
              traders managing family capital, prop desks, and portfolio
            ...
            <p className="mt-6 text-[#686868] text-[13px]">
              Managing a friends-and-family fund and navigating the operational
              side?{" "}
