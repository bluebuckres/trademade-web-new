        ...
        <div className="grid grid-cols-1 lg:grid-cols-[1fr_320px] gap-16 items-start">
          <article>
            ...
            <header className="mb-10 border-b-2 border-[#0c0c0c] pb-8">
              ...
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-6 mb-5">
                ...
                <ShareButtons title="How to Sell Your Trading Strategy Online in India | TradeMade" />
              </div>
            </header>
            ...
            <div className="text-[17px] leading-[1.8] font-light text-[#0c0c0c]">
              <p className="mb-6">
                ...
                letting others run it, you've probably also discovered that
                actually doing it is surprisingly difficult.
              </p>

              <p className="mb-6">
                This is the story of <strong>Vikram</strong> — a quant trader
                from Pune who spent three years trying to list his algo on
                various platforms before finding something that actually worked.
              </p>
              ...
              <p className="mb-6">
                Vikram's mean-reversion strategy on Nifty 50 stocks had 18
                months of live audited results. Not backtested — live. He wasn't
                selling hope. He had an edge, documented, with real trade logs.
              </p>

              <p className="mb-6">
                What he wanted was simple: let other traders run his strategy
                without him babysitting their accounts manually or handing over
                his source code.
              </p>
              ...
              <div className="flex flex-col gap-8 my-10">
                ...
                <div>
                  ...
                  <p className="text-[#3a3a3a] leading-[1.6]">
                    The first platform had decent traffic. But to list, he had
                    to rebuild his strategy in their proprietary scripting
                    language. Three weeks of migration work. When the
                    backtesting results came out inconsistent — not dramatically
                    wrong, but wrong in ways he couldn't explain — he asked
                    support. He got a template reply about "market conditions."
                    He never listed.
                  </p>
                </div>
                ...
                <div className="pl-4 md:pl-6 border-l border-[#dad5cc]">
                  ...
                  <p className="text-[#3a3a3a] leading-[1.6]">
                    ...
                    registered. Every serious buyer Vikram spoke to asked the
                    same question first: <em>"Is this SEBI-compliant?"</em> He
                    couldn't answer yes. Conversations died there. Every time.
                  </p>
                </div>
                ...
                <div className="pl-8 md:pl-12 border-l-2 border-[#dad5cc]">
                  ...
                  <p className="text-[#3a3a3a] leading-[1.6]">
                    ...
                    people who expressed interest used Upstox, Angel One, or
                    Fyers. Every time he told them it wouldn't work on their
                    broker, he watched a potential subscriber walk away.
                  </p>
                </div>
              </div>
              ...
              <div className="py-6 my-10 border-y border-[#dad5cc]">
                <p className="font-playfair text-[20px] font-semibold italic leading-[1.5] text-[#3a3a3a] m-0">
                  "I wasn't trying to build a hobby project. I wanted to run a
                  real algo business. The infrastructure kept treating me like I
                  wasn't."
                </p>
              </div>
              ...
              <ul className="list-none space-y-3 my-8 bg-[#edeae2] p-6 border border-[#dad5cc]">
                ...
                <li className="flex gap-3 items-start">
                  <span className="text-[#0c0c0c] font-bold">✓</span>{" "}
                  <span className="text-[#3a3a3a]">
                    No-code parameter adjustment for buyers — without exposing
                    his logic
                  </span>
                </li>
              </ul>
              ...
              <div className="bg-[#0c0c0c] text-white p-8 my-12 relative overflow-hidden group">
                ...
                <p className="text-white/80 text-[15px] mb-6 relative z-10 max-w-[90%]">
                  TradeMade is SEBI RA registered, supports multi-broker
                  deployment, and protects your strategy logic completely.
                </p>
                <Link
                  href="/services"
              ...
              <p className="mb-6">
                ...
                rebuilding the backtest from scratch on tick data to make sure
                the published numbers were honest.
              </p>
              <p className="mb-6">
                The multi-broker deployment meant it didn't matter which broker
                a subscriber used. The no-code interface meant buyers could
                adjust parameters themselves. His code stayed private.
              </p>
              ...
              <p className="mb-6">
                ...
                parameter tweak after a market regime change. The support load
                that used to eat his evenings (broker connection issues, order
                placement questions, settings problems) is handled by the
              ...
              <p className="mb-6">
                Here's the honest version of what you need before listing
                anywhere:
              </p>
                  ...
                  <tbody className="divide-y divide-[#dad5cc]">
                    <tr className="hover:bg-[#fafaf7]">
                      ...
                      <td className="py-3 px-4 text-[#3a3a3a]">
                        Serious buyers will ask. Backtest-only credibility is
                        thin.
                      </td>
                    </tr>
                    <tr className="hover:bg-[#fafaf7]">
                    ...
                    <tr className="hover:bg-[#fafaf7]">
                      ...
                      <td className="py-3 px-4 text-[#3a3a3a]">
                        You shouldn't have to choose between distribution and
                        IP.
                      </td>
                    </tr>
                    <tr className="hover:bg-[#fafaf7]">
              ...
              <div className="mt-14 pt-8 border-t-2 border-[#0c0c0c] text-[14px]">
                <p className="mb-4 text-[#3a3a3a] italic">
                  TradeMade's algo marketplace is SEBI RA registered and
                  supports multi-broker deployment across major Indian brokers
                  including Zerodha, Upstox, Angel One, and Fyers.
                </p>
          ...
          <aside className="hidden lg:block relative h-full">
            <div className="sticky top-24 pt-8 border-t-2 border-[#0c0c0c] lg:border-t-0 lg:pt-0">
              <RecentPostsSidebar currentSlug="/blog/how-to-sell-your-trading-strategy-online" />
            </div>
          </aside>
