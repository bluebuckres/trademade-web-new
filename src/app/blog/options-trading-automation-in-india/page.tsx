      ...
      <article className="max-w-[680px] mx-auto px-6 pt-8 md:pt-0">
        ...
        <header className="mb-10 border-b-2 border-[#0c0c0c] pb-8">
          ...
          <p className="text-[18px] font-light text-[#3a3a3a] leading-[1.6] mb-5 font-playfair italic">
            An honest guide to automating options strategies on Indian markets —
            the real complexity, the real risks, and how traders are actually
            doing it.
          </p>
        ...
        <div className="text-[17px] leading-[1.8] font-light text-[#0c0c0c]">
          ...
          <p className="mb-6">
            The pitch sounds clean: automate your iron condor, your straddle,
            your short strangle. Let the system manage strikes, monitor Greeks,
            roll positions — while you do something else.
          </p>
          ...
          <p className="mb-6">
            ...
            Bengaluru who's been trading Nifty and BankNifty weekly expiries for
            three years — learned when he tried to automate his setup. And what
            actually worked.
          </p>
          ...
          <p className="mb-6">
            ...
            relatively contained: price, volume, a few indicators, a stop loss
            level.
          </p>
          ...
          <ul className="list-disc pl-5 space-y-2 mb-6 text-[16px] text-[#3a3a3a]">
            <li>
              <strong>Strike selection</strong> that adjusts based on current
              spot price and target delta
            </li>
            <li>
            ...
            <li>
              <strong>Greeks monitoring</strong> — delta drift, gamma exposure
              as expiry approaches
            </li>
            <li>
              <strong>Adjustment logic</strong> — when to roll, when to hedge,
              when to close early
            </li>
            <li>
              <strong>Expiry-specific rules</strong> — weekly vs monthly, what
              to do on expiry day itself
            </li>
            <li>
          ...
          <div className="bg-[#0c0c0c] text-white p-6 my-8 font-syne text-[18px] font-bold tracking-[-0.01em] border-l-4 border-[#686868]">
            Most platforms that support "options automation" handle entry and
            exit. They don't handle the adaptive logic that makes options
          ...
          <p className="mb-6">
            ...
            expiries — sell OTM call and put, collect premium, manage if spot
            moved against either leg.
          </p>
          ...
          <p className="mb-6">
            Specifically — when spot moved 1.2% against one leg, he would roll
            that leg further OTM and add a hedge. The decision wasn't binary. It
            depended on how much time was left to expiry, what the premium on
            the threatened leg still was, and whether overall position delta had
            crossed his threshold.
          </p>

          <p className="mb-6 font-bold text-[#0c0c0c]">
            That's not an IF/THEN rule. That's a multi-variable decision that
            changes based on market conditions.
          </p>

          <p className="mb-6">
            His first automation handled entry and exit fine. It didn't handle
            the middle — the adjustments. Those still required him to be at the
            screen, which meant he'd automated the boring part and was still
            manually doing the important part.
          </p>
          ...
          <div className="py-6 my-10 border-y border-[#dad5cc]">
            <p className="font-playfair text-[20px] font-semibold italic leading-[1.5] text-[#3a3a3a] m-0">
              ...
              somehow more stressful than just trading manually from the start."
            </p>
          </div>
          ...
          <div className="bg-[#0c0c0c] text-white p-8 my-12 relative overflow-hidden group">
            ...
            <p className="text-white/80 text-[15px] mb-6 relative z-10 max-w-[90%]">
              The entry and exit are the easy part. Here's how to think about
              automating the logic in between.
            </p>
            <Link
              href="/services"
            ...
            >
              See TradeMade's options capabilities <ArrowRight weight="bold" />
            </Link>
          </div>
          ...
          <p className="mb-6">
            Karan spent six weeks doing something uncomfortable — writing out
            every possible scenario his strategy could encounter and defining
            exactly what he would do in each one.
          </p>
          ...
          <ul className="list-disc pl-5 space-y-3 mb-8 text-[16px] text-[#3a3a3a] bg-[#edeae2] p-6 border border-[#dad5cc]">
            <li>
              ...
              points IF premium received on roll ≥ ₹15. If not, add a long call
              hedge at 50 delta.
            </li>
            <li>
              If 2 days to expiry and position is profitable by {">"}60% of max
              premium, close entirely.
            </li>
            <li>
          ...
          <p className="mb-6">
            It took longer than he expected. But by the end, he had a document
            that was essentially a decision tree — and a decision tree can be
            automated.
          </p>
          ...
          <div className="flex flex-col gap-6 my-8">
            <div className="border border-[#dad5cc] bg-white p-5 pl-8 relative">
              ...
              <p className="text-[14px] text-[#3a3a3a] m-0">
                The strategy selects strikes based on live spot price and target
                delta at entry time, not fixed strikes set the day before.
              </p>
            </div>
            <div className="border border-[#dad5cc] bg-white p-5 pl-8 relative">
              <div className="absolute top-0 bottom-0 left-0 w-2.5 bg-[#0c0c0c]" />
              ...
              <p className="text-[14px] text-[#3a3a3a] m-0">
                Entry and exit of both legs as a single strategy action, not two
                separate orders placed manually.
              </p>
            </div>
            <div className="border border-[#dad5cc] bg-white p-5 pl-8 relative">
              <div className="absolute top-0 bottom-0 left-0 w-2.5 bg-[#0c0c0c]" />
              ...
              <p className="text-[14px] text-[#3a3a3a] m-0">
                Position delta monitoring with rule-based roll and hedge logic
                firing automatically when thresholds are crossed.
              </p>
            </div>
            <div className="border border-[#dad5cc] bg-white p-5 pl-8 relative">
              <div className="absolute top-0 bottom-0 left-0 w-2.5 bg-[#0c0c0c]" />
          ...
          <p className="mb-6">
            Karan has been running the fully automated version for four months.
            Honest comparison:
          </p>
            ...
            <table className="w-full text-left text-[14px] min-w-[600px] border-collapse">
              ...
              <tbody className="divide-y divide-[#dad5cc]">
                ...
                <tr className="hover:bg-[#fafaf7]">
                  ...
                  <td className="py-3 px-4 font-bold text-[#0c0c0c]">Zero</td>
                </tr>
                <tr className="hover:bg-[#fafaf7]">
                  <td className="py-3 px-4 text-[#3a3a3a] font-medium">
                    P&L consistency
          ...
          <p className="mb-6">
            Manual options selling has a specific psychological trap: positions
            that are losing look worse than they are, and you close them too
            early. Positions that are recovering look better than they are, and
            you hold them too long. Karan knew this about himself. He just
            couldn't stop doing it.
          </p>

          <p className="mb-6 font-bold text-[#0c0c0c]">
            The automation doesn't know what the P&L was an hour ago. It knows
            the current delta and the rules. That's it.
          </p>
          ...
          <ol className="list-decimal pl-5 space-y-4 mb-8 text-[16px]">
            <li>
              <strong>Define every scenario before you build.</strong> If you
              can't write it as a rule, you can't automate it. Options
              strategies with vague adjustment logic will fail in automation.
            </li>
            <li>
              <strong>
                Start with a fully systematic strategy, not a hybrid.
              </strong>{" "}
              Half-manual, half-automated is usually worse than either extreme.
            </li>
            <li>
              <strong>
                Backtest on real options data — strikes, premiums, IV history.
              </strong>{" "}
              Backtesting options on equity price data alone misses everything
              that matters.
            </li>
            <li>
              <strong>Understand margin dynamics.</strong> Automated strategies
              can hit margin limits fast in volatile sessions. Build margin
              buffers into your position sizing.
            </li>
            <li>
              <strong>Your first automated month will be uncomfortable.</strong>{" "}
              Watching the system make decisions you'd override manually takes
              adjustment. Trust the rules you wrote or change them — don't
              override live.
            </li>
          </ol>
          ...
          <div className="mt-14 pt-8 border-t-2 border-[#0c0c0c] text-[14px]">
            <p className="mb-4 text-[#3a3a3a] italic">
              TradeMade supports options strategy automation including dynamic
              strike selection, multi-leg order management, and condition-based
              adjustment logic. Built for Indian markets — Nifty and BankNifty
