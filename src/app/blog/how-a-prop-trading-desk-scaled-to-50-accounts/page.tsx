      ...
      <article className="max-w-[680px] mx-auto px-6 pt-8 md:pt-0">
        ...
        <header className="mb-10 border-b-2 border-[#0c0c0c] pb-8">
          ...
          <p className="text-[18px] font-light text-[#3a3a3a] leading-[1.6] mb-5 font-playfair italic">
            The operational reality of running a prop desk in India — and the
            infrastructure that made consistent multi-account execution actually
            possible.
          </p>
        ...
        <div className="text-[17px] leading-[1.8] font-light text-[#0c0c0c]">
          ...
          <p className="mb-6">
            In practice it's mostly an operations problem. More accounts means
            more execution points, more broker relationships, more things that
            can go wrong at 9:15am on a volatile morning — and more people whose
            capital you're responsible for when they do.
          </p>

          <p className="mb-6">
            <strong>Sandeep</strong> runs a prop desk in Mumbai. When he was
            managing 12 accounts, the operation was manageable. Uncomfortable,
            but manageable. By the time he crossed 30, it had become a second
            full-time job — one that paid in stress rather than salary.
          </p>
          ...
          <p className="mb-6">
            Sandeep's desk ran three core strategies across accounts of varying
            sizes. Different traders, different brokers, different capital
            bases, same underlying logic. On paper: straightforward.
          </p>
          ...
          <div className="bg-[#edeae2] p-6 my-8 border border-[#dad5cc]">
            ...
            <ul className="list-disc pl-5 space-y-2 text-[15px] text-[#3a3a3a]">
              ...
              <li>
                Place the opening signal across accounts before the first candle
                closed
              </li>
              <li>
              ...
              <li>
                Handle the calls from traders whose accounts showed different
                fills
              </li>
            </ul>
          </div>
          ...
          <p className="mb-6">
            <strong>The execution gap was the core problem.</strong> By the time
            a signal was manually replicated across 30+ accounts, the first
            accounts in had clean fills. The last accounts in were getting
            whatever was left at a price that had moved 8–15 ticks.
          </p>
          ...
          <p className="mb-6">
            That inconsistency wasn't just an operational nuisance — it was a
            trust problem. When traders in the same desk with the same strategy
            see different returns, the assumption isn't "execution lag." The
            assumption is favouritism. Sandeep was spending more time managing
            those conversations than managing the strategies.
          </p>
          ...
          <p className="mb-6">
            The obvious solution was to hire. Another execution person, maybe
            two, to handle account management in parallel. Sandeep almost did
            it. He interviewed three candidates.
          </p>

          <p className="mb-6">
            Then he did the math: ₹40,000–₹60,000/month per person, plus the
            training time, plus the human error they'd introduce, plus the fact
            that even two people placing orders manually would still have
            sequential execution — which meant the gap problem wouldn't
          ...
          <div className="py-6 my-10 border-y border-[#dad5cc]">
            <p className="font-playfair text-[20px] font-semibold italic leading-[1.5] text-[#3a3a3a] m-0">
              ...
              running a manual order placement operation that happened to have a
              strategy attached to it."
            </p>
          </div>

          <p className="mb-6 font-bold text-[#0c0c0c]">
            Hiring more people to do a manual job faster isn't a solution. It's
          ...
          <ul className="space-y-6 my-8">
            ...
            <li className="flex gap-4 items-start">
              ...
              <div>
                ...
                If one broker's API went down, other accounts should continue
                unaffected.
              </div>
            </li>
          </ul>
          ...
          <p className="mb-6 font-bold text-[#0c0c0c]">
            Most solutions he evaluated cleared two or three of these. TradeMade
            cleared all five.
          </p>
          ...
          <p className="mb-6">
            Sandeep migrated the desk over four weeks — one strategy at a time,
            running parallel execution between the old manual system and
            TradeMade to verify results matched before fully switching over.
          </p>

          <p className="mb-6">
            The migration itself was the validation. Running both systems
            side-by-side made the execution gap visible in real numbers for the
            first time. The manual accounts were averaging 6–11 tick slippage on
            entries versus the TradeMade-executed accounts. On a 50-lot
            position, that difference per trade was material.
          </p>
            ...
            <table className="w-full text-left text-[14px] min-w-[500px] border-collapse">
              ...
              <tbody className="divide-y divide-[#dad5cc]">
                ...
                <tr className="hover:bg-[#fafaf7]">
                  ...
                  <td className="py-3 px-4 font-bold text-[#0c0c0c]">Rare</td>
                </tr>
              </tbody>
            </table>
          </div>
          ...
          <p className="mb-6">
            ...
            execution headcount. The two people who had been doing manual order
            placement moved to strategy research — which is what Sandeep had
            originally hired them to do.
          </p>
          ...
          <p className="mb-6">
            ...
            somewhere between 15 and 40, depending on how many strategies they
            run and how many brokers they support. The ceiling isn't capital. It
            isn't strategy quality. It's always operations.
          </p>

          <p className="mb-6">
            The desks that scale past it aren't the ones with better traders.
            They're the ones that stopped treating execution as a human job.
          </p>
          ...
          <ol className="list-decimal pl-5 space-y-4 mb-8 text-[16px]">
            <li>
              ...
              traders see different P&L for the same strategy, your edge doesn't
              matter. The trust problem kills the desk first.
            </li>
            <li>
              <strong>Broker diversity is non-negotiable at scale</strong> —
              forcing all accounts onto one broker creates operational fragility
              and limits who can participate.
            </li>
            <li>
              <strong>Per-account risk parameters need to be systematic</strong>{" "}
              — applying uniform lot sizes across different capital bases is how
              you blow up a small account during a volatile session.
            </li>
            <li>
              <strong>Monitoring needs to be real-time, not EOD</strong> —
              discovering a missed execution at 5pm is discovering it 7 hours
              too late.
            </li>
          </ol>
          ...
          <div className="mt-14 pt-8 border-t-2 border-[#0c0c0c] text-[14px]">
            <p className="mb-4 text-[#3a3a3a] italic">
              TradeMade's multi-account deployment infrastructure supports prop
              desks managing 50+ accounts across multiple brokers with
              same-second execution, per-account position sizing, and real-time
              monitoring.
            </p>
