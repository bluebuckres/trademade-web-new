      ...
      <article className="max-w-[680px] mx-auto px-6 pt-8 md:pt-0">
        ...
        <div className="text-[17px] leading-[1.8] font-light text-[#0c0c0c]">
          <p className="mb-6">
            ...
            underperforms live, you probably don't have a strategy problem. You
            have a data problem.
          </p>

          <p className="mb-6">
            This is the story of how <strong>Raghunath</strong> — an intraday
            momentum trader from Hyderabad — spent eight months blaming bad luck
            before he found the real culprit.
          </p>
          ...
          <p className="mb-6">
            ...
            Clean, rule-based, no discretion. He'd backtested it thoroughly on
            1-minute OHLC data and the numbers looked solid.
          </p>

          <p className="mb-6">
            But every single month, his live P&L came in ₹15,000–₹20,000 short
            of what the backtest projected.
          </p>

          <p className="mb-6">
            He adjusted position sizes. He tweaked entry conditions. He switched
            brokers once. Nothing moved the needle.
          </p>

          <div className="bg-[#0c0c0c] text-white p-6 my-8 font-syne text-[18px] font-bold tracking-[-0.01em] border-l-4 border-[#686868]">
            The gap wasn't in his strategy. It was hiding inside every single
            candle.
          </div>
          ...
          <p className="mb-6">
            When you backtest on 1-minute OHLC data, your strategy executes at
            the candle open. Clean, simple, the way most retail traders set it
            up.
          </p>
          ...
          <p className="mb-6">
            ...
            that's your entire month's edge — gone. Raghunath was losing roughly{" "}
            <strong>₹600 per day</strong> to slippage he couldn't see because
            his data wasn't granular enough to show it.
          </p>
          ...
          <p className="mb-6">
            Tick data captures every single transaction — every bid, every ask,
            every executed order on the exchange. When you backtest on tick
            data, there's no hiding behind candle opens. Your strategy has to
            survive the real microstructure of the market.
          </p>

          <p className="mb-6">
            He re-ran his strategy on TradeMade using tick-level data for the
            same 6-month period. The simulated results dropped. Which was
            actually good news — because it meant the model finally matched
            reality.
          </p>
          ...
          <div className="py-6 my-10 border-y border-[#dad5cc]">
            <p className="font-playfair text-[20px] font-semibold italic leading-[1.5] text-[#3a3a3a] m-0">
              "The backtest wasn't wrong about the strategy. It was wrong about
              the world the strategy was operating in."
            </p>
          </div>
          ...
          <div className="flex flex-col gap-6 my-8">
            <div className="border border-[#dad5cc] bg-white p-6">
              ...
              <p className="text-[#3a3a3a] m-0">
                Tightened entry conditions to only trigger when a minimum volume
                threshold was present at the entry price level — not just when
                price hit the level.
              </p>
            </div>
            <div className="border border-[#dad5cc] bg-white p-6">
              ...
              <p className="text-[#3a3a3a] m-0">
                Added a small spread buffer to limit orders placed in the first
                30 minutes, when bid-ask spreads on mid-caps are widest.
              </p>
            </div>
          </div>

          <p className="mb-6">
            Neither change was dramatic. Both required seeing tick-level data to
            even know they were needed.
          </p>
            ...
            <table className="w-full text-left text-[14px] min-w-[500px] border-collapse">
              ...
              <tbody className="divide-y divide-[#dad5cc]">
                <tr className="hover:bg-[#fafaf7]">
                  ...
                  <td className="py-3 px-4 text-[#686868]">₹15,000–₹20,000</td>
                ...
                <tr className="hover:bg-[#fafaf7]">
                  ...
                  <td className="py-3 px-4 font-bold text-[#0c0c0c]">94–97%</td>
                </tr>
                <tr className="hover:bg-[#fafaf7]">
                  <td className="py-3 px-4 text-[#3a3a3a] font-medium">
          ...
          <ol className="list-decimal pl-5 space-y-4 mb-8 text-[16px]">
            <li>
              <strong>Are you backtesting on 1-min or 5-min OHLC data?</strong>{" "}
            ...
            <li>
              <strong>Have you modelled execution delay?</strong> Even 2 seconds
              matters in momentum trading.
            </li>
          </ol>

          <p className="mb-6">
            Tick data won't fix a broken strategy. But if your strategy has a
            real edge and you're still losing to the market, the data is usually
            where the answer is.
          </p>
          ...
          <div className="mt-14 pt-8 border-t-2 border-[#0c0c0c] text-[14px]">
            <p className="mb-4 text-[#3a3a3a] italic">
              ...
              quants who are serious about the gap between backtest and live.
            </p>
